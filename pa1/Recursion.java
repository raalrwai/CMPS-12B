...
//12b
//4/5/16
//Recursively reverses an array using different methods and prints the max
//and minimum of the given array
class Recursion {

  // reverseArray1()
  // Places the leftmost n elements of X[] into the rightmost n posi
  ...
  static int minArrayIndex(int[] X, int p, int r){
    if (p<r){
      int g, h;
      g = minArrayIndex(X,p,(p+r)/2);
      h = minArrayIndex(X,((p+r)/2)+1,r);
        if(X[g]<X[h])
          return g;
        else{
          return h;
